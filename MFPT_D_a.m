...
a1=0.6;b1=1.2;v=0.45;r=1;c=0.005;e=0.05;A=0.3;
xs1=1.82;xs2=0.56;xs4=-xs1;xs3=-xs2;%xs1,xs2>0 (xs1,ys1)(xs2,ys2)是正势阱点  
ys1=0.166;ys2=0.05;ys4=-ys1;ys3=-ys2;
xu1=1.22;xu2=0;xu3=-xu1;%xu1>0;(xu1,yu1)是正势阱点
yu1=0.111;yu2=0;yu3=-yu1;
D=0.001:0.005:0.35;
us1=((1/2).*a1.*((xs1-b1).^2)+v.*exp((-(xs1-b1).^2)./(r.^2)))+(e/2)*ys1.^2+(c/2)*((xs1.^2)+(ys1.^2))-c.*xs1.*ys1;
us2=((1/2).*a1.*((xs2-b1).^2)+v.*exp((-(xs2-b1).^2)./(r.^2)))+(e/2)*ys2.^2+(c/2)*((xs2.^2)+(ys2.^2))-c.*xs2.*ys2;
us4=us1;us3=us2;
...
a1=0.7;b1=1.2;v=0.45;r=1;c=0.005;e=0.05;A=0.3;
xs1=1.68;xs2=0.69;xs4=-xs1;xs3=-xs2;%xs1,xs2>0 (xs1,ys1)(xs2,ys2)是正势阱点  
ys1=0.153;ys2=0.06;ys4=-ys1;ys3=-ys2;
xu1=1.23;xu2=0;xu3=-xu1;%xu1>0;(xu1,yu1)是正势阱点
yu1=0.112;yu2=0;yu3=-yu1;
D=0.001:0.005:0.35;
us1=((1/2).*a1.*((xs1-b1).^2)+v.*exp((-(xs1-b1).^2)./(r.^2)))+(e/2)*ys1.^2+(c/2)*((xs1.^2)+(ys1.^2))-c.*xs1.*ys1;
us2=((1/2).*a1.*((xs2-b1).^2)+v.*exp((-(xs2-b1).^2)./(r.^2)))+(e/2)*ys2.^2+(c/2)*((xs2.^2)+(ys2.^2))-c.*xs2.*ys2;
us4=us1;us3=us2;
...
legend('T_{s12},a=0.5','T_{s21},a=0.5','T_{s23},a=0.5','T_{s12},a=0.6','T_{s21},a=0.6','T_{s23},a=0.6','T_{s12},a=0.7','T_{s21},a=0.7','T_{s23},a=0.7')
