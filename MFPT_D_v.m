...
a1=0.5;b1=1.2;v=0.55;r=1;c=0.005;e=0.05;A=0.3;
xs1=2.08;xs2=0.31;xs4=-xs1;xs3=-xs2;%xs1,xs2>0 (xs1,ys1)(xs2,ys2)是正势阱点  
ys1=0.189;ys2=0.028;ys4=-ys1;ys3=-ys2;
xu1=1.21;xu2=0;xu3=-xu1;%xu1>0;(xu1,yu1)是正势阱点
yu1=0.11;yu2=0;yu3=-yu1;
D=0.001:0.005:0.35;
us1=((1/2).*a1.*((xs1-b1).^2)+v.*exp((-(xs1-b1).^2)./(r.^2)))+(e/2)*ys1.^2+(c/2)*((xs1.^2)+(ys1.^2))-c.*xs1.*ys1;
...
a1=0.5;b1=1.2;v=0.65;r=1;c=0.005;e=0.05;A=0.3;
xs1=2.17;xs2=0.22;xs4=-xs1;xs3=-xs2;%xs1,xs2>0 (xs1,ys1)(xs2,ys2)是正势阱点  
ys1=0.198;ys2=0.02;ys4=-ys1;ys3=-ys2;
xu1=1.21;xu2=0;xu3=-xu1;%xu1>0;(xu1,yu1)是正势阱点
yu1=0.11;yu2=0;yu3=-yu1;
D=0.001:0.005:0.35;
us1=((1/2).*a1.*((xs1-b1).^2)+v.*exp((-(xs1-b1).^2)./(r.^2)))+(e/2)*ys1.^2+(c/2)*((xs1.^2)+(ys1.^2))-c.*xs1.*ys1;
...
legend('T_{s12},V=0.45','T_{s21},V=0.45','T_{s23},V=0.45','T_{s12},V=0.55','T_{s21},V=0.55','T_{s23},V=0.55','T_{s12},V=0.65','T_{s21},V=0.65','T_{s23},V=0.65')
