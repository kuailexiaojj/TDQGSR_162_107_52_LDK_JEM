clear all;clc;
a1=0.5;b1=1.2;v=0.45;r=0.8;c=0.005;e=0.05;A=0.3;
xs1=2;xs2=0.38;xs4=-xs1;xs3=-xs2;%xs1,xs2>0 (xs1,ys1)(xs2,ys2)是正势阱点  
ys1=0.182;ys2=0.035;ys4=-ys1;ys3=-ys2;
...
a1=0.5;b1=1.2;v=0.45;r=0.9;c=0.005;e=0.05;A=0.3;
xs1=1.99;xs2=0.39;xs4=-xs1;xs3=-xs2;%xs1,xs2>0 (xs1,ys1)(xs2,ys2)是正势阱点  
ys1=0.181;ys2=0.036;ys4=-ys1;ys3=-ys2;
xu1=1.21;xu2=0;xu3=-xu1;%xu1>0;(xu1,yu1)是正势阱点
yu1=0.11;yu2=0;yu3=-yu1;
D=0.001:0.005:0.35;
us1=((1/2).*a1.*((xs1-b1).^2)+v.*exp((-(xs1-b1).^2)./(r.^2)))+(e/2)*ys1.^2+(c/2)*((xs1.^2)+(ys1.^2))-c.*xs1.*ys1;
...
legend('T_{s12},R=0.8','T_{s21},R=0.8','T_{s23},R=0.8','T_{s12},R=0.9','T_{s21},R=0.9','T_{s23},R=0.9','T_{s12},R=1','T_{s21},R=1','T_{s23},R=1')
